...
def add_board_update(tab_name):
    ...
    if notes_key in st.session_state and st.session_state[notes_key].strip():
        ...
        if tab_name == "Executive Summary":
            # Updated content with all the new highlights, opportunities, and considerations
            update_content = """
            <div style="margin-bottom: 15px;">
                ...
                <ul style="margin-left: 20px; line-height: 1.6;">
                    ...
                    <li><strong>90%</strong> coaches recruited and trained to in new Mommy & Me Program</li>

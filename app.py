...
def add_board_update(tab_name, update_content):
    """
    Add a board update section to the top of a tab
    ...
    <div style="background-color: #F3F9FF; border-left: 5px solid #0088FF; 
         padding: 15px; border-radius: 5px; margin: 15px 0 25px 0; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        <h4 style="color: #0088FF; margin-top: 0;">Board Update: {tab_name}</h4>
        {update_content}
        <div style="text-align: right; font-style: italic; font-size: 12px; color: #666;">
            Updated: April 25, 2025
        </div>
    </div>
    """
    return st.markdown(board_update_html, unsafe_allow_html=True)
